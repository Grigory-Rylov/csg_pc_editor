...
class Trackball(private val cfg: KeyboardConfig, private val keyPlace: KeyPlace) {
    ...
    fun create(): ModelHolder {
        ...
        val vertex = mutableListOf(fromModel(moveTrackball(model), Color.LIGHT_GRAY, cfg.fn))
    ...
    fun createTrackballSensor(): ModelHolder {
        ...
        return ModelHolder(
            ...
            fromModel(moveTrackball(trackballSensor), Color.ORANGE, 20),
        )
    }
    ...
    fun createSensorCap(): ModelHolder {
        ...
        return ModelHolder(
            moveTrackball(model),
            fromModel(moveTrackball(model), Color.BLUE, cfg.fn),
        )
    }
