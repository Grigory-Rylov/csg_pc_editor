...
import com.github.grishberg.cad3d.common.cmd.*;
...
public class DebugRecorderImpl implements DebugRecorder {
    ...
    @Override
    public void onMultiplePolygons(V3d p0, V3d p1, List<Polygon> polygons) {
        commands.add(new NonManifoldEdgesCmd(p0, p1, polygons));
    }

    @Override
    public void onFloatingEdge(V3d p0, V3d p1, Polygon polygon) {
        List<Polygon> p = new ArrayList<>();
        p.add(polygon);
        commands.add(new NonManifoldEdgesCmd(p0, p1, p));
