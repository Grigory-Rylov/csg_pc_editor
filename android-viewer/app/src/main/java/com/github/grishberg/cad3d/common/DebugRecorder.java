...
public interface DebugRecorder {
    ...
    void onDebugNakedEdgeWithNearbyFacets(Polygon polygon, V3d pointA, V3d pointB, Facet facet,
                                          List<PolygonValidator.PolygonEdge> nearby);

    void onDebugNakedEdgeWithNearbyFacets(Polygon polygon, V3d pointA, V3d pointB, Facet facet,
                                          List<PolygonValidator.PolygonEdge> nearby, List<Facet> facets);

    void onMultiplePolygons(V3d p0, V3d p1, List<Polygon> polygons);

    void onFloatingEdge(V3d p0, V3d p1, Polygon polygon);
}
