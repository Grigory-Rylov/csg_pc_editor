...
public class ThumbKeyPlace {
    ...
    public static Abstract3dModel placeR(Abstract3dModel obj) {
        return place(obj, 14, -40, 10, new V3d(-5 + OFFSET_X, -10 + OFFSET_Y, 5 + OFFSET_Z));
    }

    public static Abstract3dModel placeM(Abstract3dModel obj) {
        return place(obj, 12, -39, 22, new V3d(-22+ OFFSET_X, -14 + OFFSET_Y, -7 + OFFSET_Z));
    }

    public static Abstract3dModel placeL(Abstract3dModel obj) {
        return place(obj, 8, -44, 28, new V3d(-35.0+ OFFSET_X, -20.5 + OFFSET_Y, -21 + OFFSET_Z));
    }
